...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_moonlander(
    ...
    A_ATAB,         KC_Z,           KC_X,           MT(MOD_LALT, KC_C),MT(MOD_LCTL, KC_D),KC_V,                                             KC_K,           MT(MOD_RCTL, KC_H),MT(MOD_LALT, KC_COMMA),KC_DOT,         KC_SLASH,       KC_TRANSPARENT,
    ...
    LT(2,KC_SPACE), L_LOCK,         KC_TRANSPARENT,                 KC_TRANSPARENT, MO(3),          MO(2)
  ),
  ...
  [_NAV] = LAYOUT_moonlander(
    ...
    TG(5),          LCTL(KC_Q),     LCTL(KC_W),     LCTL(KC_F),     KC_PSCREEN,     LCTL(KC_Y),     KC_TRANSPARENT,         KC_TRANSPARENT, LCTL(KC_C),     KC_HOME,        KC_UP,          KC_END,         KC_INSERT,      KC_F12,
    KC_TRANSPARENT, MO(4),          KC_NO,          KC_NO,          LCTL(KC_D),     LCTL(KC_LBRACKET),KC_TRANSPARENT,       KC_TRANSPARENT, LCTL(KC_V),     KC_LEFT,        KC_DOWN,        KC_RIGHT,       MO(4),          KC_TRANSPARENT,
    KC_LGUI,        LCTL(KC_Z),     KC_APPLICATION, KC_LALT,        KC_LCTRL,       LCTL(KC_RBRACKET),                                      LCTL(KC_X),     KC_RCTRL,       KC_LALT,        KC_PGUP,        KC_PGDOWN,      A_ATAB,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [_NUM] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_PGUP,        KC_END,         KC_UP,          KC_HOME,        KC_NO,          KC_TRANSPARENT,         KC_TRANSPARENT, LCTL(KC_C),     KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_KP_MINUS,    KC_KP_PLUS,
    ...
    KC_LGUI,        KC_INSERT,      KC_DELETE,      KC_LALT,        KC_LCTRL,       KC_KP_COMMA,                                            LCTL(KC_X),     MT(MOD_RCTL, KC_KP_1),MT(MOD_LALT, KC_KP_2),KC_KP_3,        KC_KP_SLASH,    KC_EQUAL,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [2] = { {245,218,204}, {41,255,255}, {245,218,204}, {147,255,255}, {0,0,0}, {64,255,255}, {28,127,255}, {41,255,255}, {28,127,255}, {0,0,0}, {64,255,255}, {28,127,255}, {0,0,0}, {73,255,85}, {0,0,0}, {64,255,255}, {28,127,255}, {0,0,0}, {147,255,255}, {0,0,0}, {64,255,255}, {23,255,255}, {23,255,255}, {147,255,255}, {147,255,255}, {64,255,255}, {23,255,255}, {23,255,255}, {23,255,255}, {0,0,0}, {0,0,0}, {0,0,0}, {245,218,204}, {245,218,204}, {0,0,0}, {4,232,184}, {64,255,255}, {64,255,255}, {4,232,184}, {73,255,85}, {0,0,0}, {64,255,255}, {4,232,184}, {41,255,255}, {23,255,255}, {0,0,0}, {64,255,255}, {73,255,85}, {166,218,166}, {23,255,255}, {0,0,0}, {64,255,255}, {166,218,166}, {166,218,166}, {147,255,255}, {0,0,0}, {64,255,255}, {73,255,85}, {166,218,166}, {147,255,255}, {147,255,255}, {64,255,255}, {23,255,255}, {23,255,255}, {23,255,255}, {0,0,0}, {0,0,0}, {0,0,0}, {41,255,255}, {41,255,255}, {0,0,0}, {4,232,184} },
