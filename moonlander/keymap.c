...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT_moonlander(
    ...
    MO(5),          LCTL(KC_Q),     LCTL(KC_W),     LCTL(KC_Y),     LCTL(KC_D),     KC_APPLICATION, KC_TRANSPARENT,         KC_TRANSPARENT, LCTL(KC_C),     KC_HOME,        KC_UP,          KC_END,         KC_INSERT,      KC_F12,
    KC_TRANSPARENT, MO(4),          KC_PSCREEN,     LALT(KC_LEFT),  LALT(KC_RIGHT), LCTL(KC_LBRACKET),KC_TRANSPARENT,       KC_TRANSPARENT, LCTL(KC_V),     KC_LEFT,        KC_DOWN,        KC_RIGHT,       MO(4),          KC_TRANSPARENT,
    KC_LGUI,        LCTL(KC_Z),     MO(3),          KC_LALT,        KC_LCTRL,       LCTL(KC_RBRACKET),                                      LCTL(KC_X),     KC_RCTRL,       KC_LALT,        KC_PGUP,        KC_PGDOWN,      LGUI(KC_TAB),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [_NUM] = LAYOUT_moonlander(
    ...
    KC_LGUI,        KC_PGDOWN,      KC_PGUP,        KC_LALT,        KC_LCTRL,       LCTL(KC_X),                                             KC_KP_0,        KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_SLASH,    LGUI(KC_TAB),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [2] = { {245,218,204}, {41,255,255}, {245,218,204}, {147,255,255}, {0,0,0}, {64,255,255}, {28,127,255}, {41,255,255}, {28,127,255}, {0,0,0}, {64,255,255}, {28,127,255}, {4,232,184}, {41,255,255}, {0,0,0}, {64,255,255}, {23,255,255}, {4,232,184}, {147,255,255}, {0,0,0}, {64,255,255}, {23,255,255}, {4,232,184}, {147,255,255}, {147,255,255}, {64,255,255}, {73,255,85}, {23,255,255}, {23,255,255}, {0,0,0}, {0,0,0}, {0,0,0}, {41,255,255}, {245,218,204}, {0,0,0}, {4,232,184}, {64,255,255}, {64,255,255}, {4,232,184}, {64,255,255}, {0,0,0}, {64,255,255}, {28,127,255}, {41,255,255}, {23,255,255}, {0,0,0}, {64,255,255}, {73,255,85}, {166,218,166}, {23,255,255}, {0,0,0}, {64,255,255}, {166,218,166}, {166,218,166}, {147,255,255}, {0,0,0}, {64,255,255}, {73,255,85}, {166,218,166}, {147,255,255}, {147,255,255}, {64,255,255}, {4,232,184}, {4,232,184}, {4,232,184}, {0,0,0}, {0,0,0}, {0,0,0}, {41,255,255}, {245,218,204}, {0,0,0}, {4,232,184} },

    [3] = { {245,218,204}, {0,0,0}, {245,218,204}, {147,255,255}, {0,0,0}, {0,0,0}, {28,127,255}, {41,255,255}, {23,255,255}, {0,0,0}, {0,0,0}, {73,255,85}, {166,218,166}, {23,255,255}, {0,0,0}, {0,0,0}, {166,218,166}, {166,218,166}, {147,255,255}, {0,0,0}, {0,0,0}, {73,255,85}, {166,218,166}, {147,255,255}, {147,255,255}, {0,0,0}, {4,232,184}, {4,232,184}, {4,232,184}, {0,0,0}, {0,0,0}, {0,0,0}, {41,255,255}, {245,218,204}, {0,0,0}, {245,218,204}, {147,255,255}, {73,255,85}, {245,218,204}, {64,255,255}, {0,0,0}, {0,0,0}, {73,255,85}, {73,255,85}, {73,255,85}, {0,0,0}, {0,0,0}, {166,218,166}, {166,218,166}, {166,218,166}, {0,0,0}, {0,0,0}, {166,218,166}, {166,218,166}, {166,218,166}, {0,0,0}, {41,255,255}, {166,218,166}, {166,218,166}, {166,218,166}, {147,255,255}, {41,255,255}, {73,255,85}, {73,255,85}, {166,218,166}, {0,0,0}, {0,0,0}, {0,0,0}, {41,255,255}, {245,218,204}, {0,0,0}, {245,218,204} },
