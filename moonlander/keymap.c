...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT_moonlander(
    ...
    KC_NO,          KC_NO,          ST_MACRO_0,     ST_MACRO_1,     ST_MACRO_2,     ST_MACRO_3,                                           ST_MACRO_5,     KC_TILD,        KC_COMMA,       KC_DOT,         KC_QUES,        KC_NO,
